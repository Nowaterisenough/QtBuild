#!/bin/bash
# ============================================================================
# Qt 6 Linux GCC Build Script
# Parameters: QT_VERSION GCC_VERSION BUILD_TYPE LINK_TYPE SEPARATE_DEBUG VULKAN_SDK TEST_MODE
# ============================================================================
...
if [ -z "$GCC_VERSION" ]; then
    echo "ERROR: GCC_VERSION not provided"
    exit 1
fi
...
echo "=== Qt ${QT_VERSION} Linux GCC ${GCC_VERSION} Build ==="
...
# === Base Configuration ===
CFG_OPTIONS="-${LINK_TYPE} -prefix ${INSTALL_DIR} -nomake examples -nomake tests -c++std c++20 -opensource -confirm-license -qt-libpng -qt-libjpeg -qt-zlib -qt-pcre -openssl-linked -platform linux-g++ -opengl desktop"
