...
:: 设置编译器和Ninja
SET PATH=D:\a\QtBuild\Tools\llvm-mingw1706_64\bin;D:\a\QtBuild\ninja;%PATH%
...
copy D:\a\QtBuild\Tools\llvm-mingw1706_64\bin\libc++.dll %INSTALL_DIR%\bin\ 2>nul
copy D:\a\QtBuild\Tools\llvm-mingw1706_64\bin\libunwind.dll %INSTALL_DIR%\bin\ 2>nul
copy D:\a\QtBuild\Tools\llvm-mingw1706_64\bin\libwinpthread-1.dll %INSTALL_DIR%\bin\ 2>nul
